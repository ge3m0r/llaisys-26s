...
__C {
    ...
    __export uint8_t llaisysQwen2ModelLoadWeight(struct LlaisysQwen2Model *model, const char *name, const void *data, size_t nbytes);

    __export uint8_t llaisysQwen2ModelReset(struct LlaisysQwen2Model *model);
